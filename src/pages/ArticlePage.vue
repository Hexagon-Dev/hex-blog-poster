<template>
  <article>
    <h2 class="text-3xl font-black">{{ article?.title ?? 'No title' }}</h2>

    <p class="my-4">{{ article?.content ?? 'No content' }}</p>
    ...
    <div class="flex space-x-2">
      ...
      <router-link to="/" class="btn-default !ml-auto">BACK</router-link>
    </div>
  </article>
</template>
